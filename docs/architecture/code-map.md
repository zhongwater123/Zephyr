...
| `frontend.features` [component:frontend.features] | History、Hotwords、Pending、Shortcut、Settings 的局部状态和交互 | [features](../../src/features) | [前端 L3](c4-components-frontend.md) |
...
| `backend.shortcut` [component:backend.shortcut] | `RegisterHotKey` 持续预占、`WH_KEYBOARD_LL` 最佳努力独占、事务式替换和语法校验 | [manager](../../src-tauri/src/hotkey.rs), [low-level hook](../../src-tauri/src/low_level_hook.rs), [parser](../../src-tauri/src/shortcut.rs) | [后端 L3](c4-components-backend.md), [运行时](runtime-views.md) |
...
| `platform.windows` [component:platform.windows] | 原生确认框、托盘、窗口身份、悬浮窗定位与 Win32/OLE 输入 | [platform](../../src-tauri/src/platform.rs), [overlay](../../src-tauri/src/overlay.rs), [target](../../src-tauri/src/target.rs), [inject](../../src-tauri/src/inject.rs), [hotkey](../../src-tauri/src/hotkey.rs) | [部署视图](runtime-views.md), [ADR-0006](adr/0006-unicode-injection-default.md) |
