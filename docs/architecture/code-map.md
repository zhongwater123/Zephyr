...
| `platform.windows` [component:platform.windows] | 原生确认框、托盘、窗口身份、悬浮窗定位，以及隔离 sidecar 内的 Win32 剪贴板事务与按键提交 | [platform](../../src-tauri/src/platform.rs), [helper](../../src-tauri/crates/zephyr-paste-helper), [target](../../src-tauri/src/target.rs), [keyboard engine](../../src-tauri/src/windows_keyboard.rs) | [部署视图](runtime-views.md), [ADR-0018](adr/0018-owned-clipboard-transaction-and-isolated-paste.md) |
