...
| `frontend.features` [component:frontend.features] | History、Hotwords、Pending、Settings 的局部交互，以及有焦点的快捷键编辑意图与本地反馈状态 | [features](../../src/features) | [前端 L3](c4-components-frontend.md), [热键链路](shortcut-editing.md), [ADR-0010](adr/0010-separate-focused-shortcut-editing.md) |
...
| `backend.shortcut` [component:backend.shortcut] | 快捷键校验与可回滚提交事务，以及已提交绑定的 Windows 全局物理键监听 | [manager](../../src-tauri/src/shortcut_manager.rs), [physical model](../../src-tauri/src/physical_shortcut.rs), [Windows engine](../../src-tauri/src/windows_keyboard.rs) | [后端 L3](c4-components-backend.md), [运行时](runtime-views.md), [热键链路](shortcut-editing.md), [ADR-0010](adr/0010-separate-focused-shortcut-editing.md) |
